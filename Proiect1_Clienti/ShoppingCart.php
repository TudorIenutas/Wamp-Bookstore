...
class ShoppingCart extends DBController
{
 ...
 {
 $query = "SELECT tbl_product.*, tbl_cart.id as cart_id, tbl_cart.quantity FROM tbl_product, tbl_cart WHERE tbl_product.id = tbl_cart.product_id AND tbl_cart.id_member = ?";
 $params = array(
    array(
    "param_type" => "i",
